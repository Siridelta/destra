...
describe('Builder', () => {
    ...
    it('should apply prepended ID segments', () => {
        ...
        createNamed.idPrepend('namespace');
    ...
    it('should stack multiple prepends in correct order (LIFO/Outer-last)', () => {
        ...
        // The "outer" selection calls idPrepend LAST.
        // e.g. 
        // inner = selection({ b: builder }).idPrepend('inner');
        // outer = selection({ inner }).idPrepend('outer');
        //
        // Effectively: builder.idPrepend('inner') then builder.idPrepend('outer')
        ...
        createNamed.idPrepend('inner');
        createNamed.idPrepend('outer');
