...
ASTNormalizer3.prototype.commasLevel = function (node: CommasASTNode): CommasASTNode {
    node = { ...node };
...
ASTNormalizer3.prototype.addition = function (node: AdditionASTNode): AdditionASTNode { return this.addSubLevel(node); }
ASTNormalizer3.prototype.subtraction = function (node: SubtractionASTNode): SubtractionASTNode { return this.addSubLevel(node); }
ASTNormalizer3.prototype.addSubLevel = function <T extends AddSubLevelASTNode>(node: T): T {
    node = { ...node };
...
ASTNormalizer3.prototype.forClause = function (node: ForClauseASTNode): ForClauseASTNode { return this.contextType2Level(node); }
ASTNormalizer3.prototype.withClause = function (node: WithClauseASTNode): WithClauseASTNode { return this.contextType2Level(node); }
ASTNormalizer3.prototype.contextType2Level = function <T extends ContextType2LevelASTNode>(node: T): T {
    node = { ...node };
