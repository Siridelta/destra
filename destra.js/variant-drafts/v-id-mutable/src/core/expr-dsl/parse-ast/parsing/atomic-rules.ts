import { Bar, BraceClose, BraceOpen, BracketClose, BracketOpen, Comma, ParenthesisClose, ParenthesisOpen, RangeDots } from "../tokens/op-and-puncs";
...
export function initAtomicRules(this: FormulaParser) {
    this.atomicExp = this.RULE("atomicExp", () => {
        this.OR([
            ...
            { ALT: () => this.SUBRULE(this.absExp, { LABEL: "case" }) },
