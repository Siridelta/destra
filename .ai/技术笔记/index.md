...
如果想要理解项目演进过程中的技术决策背景，请参考[设计日志](../设计日志/)目录下的相关文档。
...
Destra 项目的起点非常纯粹：**我们希望在某一种主流/通用编程语言下，让用户能以代码的形式来创建、组织和管理复杂的 Desmos 图表**，从而获得代码所带来的模块化、可复用性、版本控制等强大能力。
...
4.  **计算依赖于关系网 (DAG)**：所有公式组成了一张依赖关系图。一个值的改变会顺着这张网传播。事实上公式列表这种结构本身亦可以视为这种计算树的 “SLP (Straight-Line Program)” 表征。
