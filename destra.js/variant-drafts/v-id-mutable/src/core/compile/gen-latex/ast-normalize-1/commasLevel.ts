...
ASTNormalizer1.prototype.commasLevel = function (node: CommasASTNode): CommasASTNode {
    node = { ...node };
...
ASTNormalizer1.prototype.addition = function (node: AdditionASTNode): AdditionASTNode { return this.addSubLevel(node); }
ASTNormalizer1.prototype.subtraction = function (node: SubtractionASTNode): SubtractionASTNode { return this.addSubLevel(node); }
ASTNormalizer1.prototype.addSubLevel = function <T extends AddSubLevelASTNode>(node: T): T {
    node = { ...node };
...
ASTNormalizer1.prototype.forClause = function (node: ForClauseASTNode): ForClauseASTNode { return this.contextType2Level(node); }
ASTNormalizer1.prototype.withClause = function (node: WithClauseASTNode): WithClauseASTNode { return this.contextType2Level(node); }
ASTNormalizer1.prototype.contextType2Level = function <T extends ContextType2LevelASTNode>(node: T): T {
    node = { ...node };
