...
import { ImplicitMultASTNode, isUpToImplicitMultLevelASTNode, MultiplicationASTNode, OmittedCallASTNode } from "../../../expr-dsl/parse-ast/sematics/visitor-parts/multDiv-level";
...
ASTNormalizer1.prototype.implicitMult = function (node: ImplicitMultASTNode): ImplicitMultASTNode | MultiplicationASTNode {
    ...
    node.operands = node.operands.map(operand => {
        if (!isUpToImplicitMultLevelASTNode(operand)) {
